    ...
    xhr.onreadystatechange = function (e) {
      if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.put(serverUrl + 'updateData', data).then(function (res) {
          console.log('this is in fact running:', res); //   get();
        ...
        setTimeout(get({
          "peg": pegNumberStr
        }), 1000); // Create a thumbnail of the uploaded image, with 150px width
...
//# sourceMappingURL=mypegs.js.22dda1c7ed998500993f.hot-update.js.map